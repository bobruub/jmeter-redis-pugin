...
public class DummySamplerGui extends AbstractSamplerGui {
  ...
  private JPanel createDummySamplerPanel(){
    ...
    // redis
    JLabel redisServerLabel = new JLabel("Redis Server");
    JLabel redisPortLabel = new JLabel("Redis Port");
    //redis
...
//redis
            .addGroup(layout.createParallelGroup(Alignment.LEADING)
                .addComponent(redisServerLabel, GroupLayout.PREFERRED_SIZE,
                  GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
            .addComponent(redisServer, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE,
                  GroupLayout.PREFERRED_SIZE))
// redis
//redis
            .addGroup(layout.createParallelGroup(Alignment.LEADING)
                .addComponent(redisPortLabel, GroupLayout.PREFERRED_SIZE,
                    GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
            .addComponent(redisPort, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE,
                    GroupLayout.PREFERRED_SIZE))
// redis
  ...
  public void modifyTestElement(TestElement element) {
    ...
    if (element instanceof DummySampler) {
      ...
      dummySampler.setRedisServer(redisServer.getText());
      dummySampler.setRedisPort(redisPort.getText());
